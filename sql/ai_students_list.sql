drop table ai_students_list;
create table ai_students_list
(
...
Password varchar (40),
UG varchar(50),
UG_Subject varchar (70) ,
PG varchar (80),
PG_Subject varchar (70) ,
Year_of_Passing long,
AI_Batch_Email varchar (90) ,
Email varchar (70),
Address varchar (200),
District  varchar(80),
Father_Name varchar (50),
Mother_Name varchar (50));
select * from ai_students_list;
drop table ai_students_list;

insert into ai_students_list
(S_NO  ,
First_Name ,
DOB ,
Adhaar_Number  ,
